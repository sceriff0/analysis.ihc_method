...
#                  bin/utils/valis_config.py, MEMORY_PRESETS, on main AND on the
#                  benchmarking branch); `low` detects on a 256 px processed image
#                  and fits the non-rigid field at 1024 px, `high` at 2048 / 4096 px.
#                  An earlier note here — and a comment in mirage's
#                  benchmarks/configs/arms.yaml — said `low` was BRISK/RANSAC. It was
#                  never true of the shipped code; the manuscript legend's
#                  "differing in feature-matching resolution, not in the feature
#                  matcher" is the correct statement.
