...
**Split into two figures.** `marker_gene_map` carries 19 markers, and 19 free-scale
facets on one double-column figure gives each panel about 35mm — too small to read a
fit line off. The first figure takes the ten lineage and structural markers the panel
